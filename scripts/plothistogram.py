...
b1=axarr[0,0].bar(ind, cave_crc, width, color='b')#,  label="CRC")
b2=axarr[0,0].bar(ind+width,cave_cac, width, color ='g')# label="CAC")
b3=axarr[0,0].bar(ind+2.0*width,cave_nrc, width, color='r')# label="NRC")
b4=axarr[0,0].bar(ind+3.0*width,cave_fhk, width, color='c')
axarr[0,0].legend([b1,b2,b3,b4],["CRC", "CAC","NRC", "FHK"],loc=1)
...
axarr[0,0].set_xticks((ind+2*width))
axarr[0,0].set_xticklabels(num_robots)
