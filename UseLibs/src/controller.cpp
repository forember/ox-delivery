 ...
 *
**/
void Controller::run(const std::string& directory, const std::string& image, int k)
{
 ...
 *
**/
void Controller::checkInputParams(const std::string& directory, const std::string& image, int k)
{
  std::string message = "";
